...
Button.prototype.updateDimensions = function () {
    ...
    if (this.labelText) {
        ...
        this.labelText.style.fontSize = this.textStyle.fontSize * scaleY;
...
Button.prototype.createLabel = function () {
    if (this.labelText) {
        ...
        this.labelText.style = this.textStyle;
    } else {
        this.labelText = new PIXI.Text(this._label, this.textStyle);
