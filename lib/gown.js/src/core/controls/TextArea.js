var TextAreaControl = require('./TextAreaControl');
/**
...
function TextArea(theme, skinName) {
    ...
    this._validStates = this._validStates || TextAreaControl.stateNames;

    TextAreaControl.call(this, theme);
...
TextArea.prototype = Object.create(TextAreaControl.prototype);
TextArea.prototype.constructor = TextArea;
module.exports = TextArea;

// name of skin
TextArea.SKIN_NAME = 'textarea_input';
...
Object.defineProperty(TextAreaControl.prototype, 'width', {
    get: function () {
        return this._width;
    },
    set: function(value) {
