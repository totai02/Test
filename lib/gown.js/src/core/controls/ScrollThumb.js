...
function ScrollThumb(scrollable, theme, skinName) {
    ...
    this.width = theme.thumbSize || 29;
    this.height = theme.thumbSize || 32;
    ...
    /* jshint unused: false */
    this.touchend = this.touchendoutside = this.click = this.mouseup;
}
...
Object.defineProperty(ScrollThumb.prototype, 'currentState', {
    set: function (value) {
        if (typeof (this.theme) != 'undefined' && this.theme.thumbSkin) {
...
ScrollThumb.prototype.buttonmouseup = Button.prototype.mouseover;
ScrollThumb.prototype.mouseover = function (mouseData) {
    this.redraw();
};
 ...
 * @param delay
 */
ScrollThumb.prototype.timelineHeight = function(d, delay) {
    this.children[0].timelineHeight(d, delay);
}